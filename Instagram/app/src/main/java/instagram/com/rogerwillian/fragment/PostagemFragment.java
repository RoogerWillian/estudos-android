...
import instagram.com.rogerwillian.activity.FiltroActivity;
...
public class PostagemFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        buttonAbrirCamera = view.findViewById(R.id.abrir_camera);
        buttonAbrirGaleria = view.findViewById(R.id.abrir_galeria);
